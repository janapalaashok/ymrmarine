                    ...
                    <div class="sc-row">
                        ...
                        <div class="sc-actions">
                            <?php if (!empty($card_info['path']) && is_file($card_info['path'])): ?>
                                ...
                                <form method="POST" onsubmit="return confirm('Remove this file?');" data-testid="surveyor-card-remove-form-<?= $card_key ?>-<?= (int)$s['id'] ?>"><?= csrf_field() ?>
                            ...
                            <?php endif; ?>
                            <form method="POST" enctype="multipart/form-data" class="d-inline" data-testid="surveyor-card-upload-form-<?= $card_key ?>-<?= (int)$s['id'] ?>"><?= csrf_field() ?>
                                <input type="hidden" name="user_id" value="<?= (int)$s['id'] ?>">
                                <input type="hidden" name="card_type" value="<?= $card_key ?>">
