 ...
 *
 * @phpstan-type AzureExternalKeyConfigParamShape = array{
 *   keyName: string,
 *   tenantID: string,
 *   type: 'azure',
 *   vaultURI: string,
 ...
 * }
 */
final class AzureExternalKeyConfigParam implements BaseModel
{
    /** @use SdkModel<AzureExternalKeyConfigParamShape> */
    use SdkModel;
    ...
    /**
     * `new AzureExternalKeyConfigParam()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AzureExternalKeyConfigParam::with(keyName: ..., tenantID: ..., vaultURI: ...)
     * ```
     *
