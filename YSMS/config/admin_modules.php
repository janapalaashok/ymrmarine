...
return [
    'ports' => [
        ...
        'fields'     => [
            ...
            ['name' => 'country',   'label' => 'Country',   'type' => 'text', 'required' => false, 'hint' => 'Leave blank for India.'],
        ],
        'fk_checks'  => [
    ...
    'agents' => [
        ...
        'fields'     => [
            ...
            ['name' => 'emails', 'label' => 'Email (one or more, comma-separated)', 'type' => 'text', 'required' => false],
        ],
        'fk_checks'  => [],
    ],
    ...
    'clients' => [
        ...
        'fields'     => [
            ['name' => 'company_name',  'label' => 'Client Name',                              'type' => 'text', 'required' => true],
            ['name' => 'short_code',    'label' => 'Short Form (auto)',                        'type' => 'text', 'required' => false, 'readonly' => true],
            ['name' => 'address_line1', 'label' => 'Address Line 1 (Door no, street)',          'type' => 'text', 'required' => false],
            ['name' => 'address_line2', 'label' => 'Address Line 2 (City, country)',            'type' => 'text', 'required' => false],
        ],
        'fk_checks'  => [
